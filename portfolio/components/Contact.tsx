...
const Contact = ({portfolio}: Props) => {
    ...
    return (
        <div className="h-screen flex relative flex-col text-center md:text-left md:flex-row max-w-7xl px-10 justify-evenly mx-auto items-center overflow-y-scroll scrollbar-none">
            <h1 className="absolute text-2xl text-gray-500 top-24 uppercase tracking-[20px]">Contact</h1>

            <div className="flex flex-col mt-60 md:mt-32">
                <h4 className="text-2xl md:text-3xl font-semi-bold text-center">
                    I have just what you need. {" "}
                    <span className="decoration-[#f7aaba]/50 underline">Lets Talk.</span>
                </h4>
                <div className=" flex flex-col items-start md:items-center justify-center  space-y-8 md:p-8 p-12">
                ...
                <form className="flex flex-col space-y-4 w-fit mx-auto p-2" onSubmit={handleSubmit(onSubmit)}>
